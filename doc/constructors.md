...
set to the `prototype` of the function object that was invoked as the
constructor.
...
workings of [`this`](#how-this-works-in-javascript) in JavaScript, it will 
use the *global object* as the value of `this`.
...
[Closure](#closures-and-references).
...
the use of [private variables](#closures) easier, it comes with some downsides.
